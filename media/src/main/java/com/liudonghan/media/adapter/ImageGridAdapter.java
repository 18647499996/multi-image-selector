package com.liudonghan.media.adapter;
...
import com.liudonghan.media.PhotoPreviewActivity;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int i) {
        ...
        if (type == TYPE_CAMERA) {
            ...
            if (mediaType == MediaSelector.VIDEO) {
                ...
                imageHolder.play.setVisibility(View.VISIBLE);
                if (data.bitmap != null)
                    imageHolder.image.setImageBitmap(data.bitmap);
            } else {
                imageHolder.play.setVisibility(View.GONE);
