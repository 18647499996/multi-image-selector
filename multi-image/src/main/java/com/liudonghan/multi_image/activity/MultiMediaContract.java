...
public interface MultiMediaContract {
    ...
    interface Presenter extends ADBasePresenter {
         ...
         * @param originData
         */
        void getMediaFile(List<ADCursorManageUtils.ImageFolderModel.MediaModel> originData);
         ...
         * @param maxCount
         */
        void onItemClick(BaseQuickAdapter adapter, android.view.View views, int position, PopupWindow listPopupWindow, int maxCount);
    }
}